...
********************************************************/
void DispShowChar(char chr, unsigned char R, unsigned char G, unsigned char B, char bias)//随机颜色
{
...
void DispShowChar2(char chr, unsigned char R, unsigned char G, unsigned char B, char bias)//正常显示
{
  unsigned char i, j, Page_Write, temp;
  unsigned char Char;
  unsigned char chrtemp[24] = {0};
...
void DispShowChar3(char chr, unsigned char R, unsigned char G, unsigned char B, char bias)//红白
{
  unsigned char i, j, Page_Write, temp;
...
void DispShowChar4(char chr, unsigned char R, unsigned char G, unsigned char B, char bias)//党徽
{
  unsigned char i, j, Page_Write, temp;
  unsigned char Char;
  unsigned char chrtemp[24] = {0};
...
for (j = ':'; j <= 'G'; j++)
 ...
 for (j = ':'; j <= 'G'; j++)
                 ...
                 delay(300);//运货慢               
 DispShowChar4('"',   0,0,255, 0);//党徽
 delay(3000);
 DispShowChar2('$',   0,0,255, 0);//空心
 delay(3000);
 DispShowChar3('%',   0,0,255, 0);//医护十字
 delay(3000);
 DispShowChar2('i',   0,0,255, 0);//笑脸
 delay(3000);
 DispShowChar5('i',   0,0,255, 0);//笑脸+口罩
 delay(3000);
 for ( k = 0; k < 5; k++)
               {
                 for (j = 'k'; j <= 'n'; j++)
 ...
 for ( k = 0; k < 5; k++)
               ...
               DispShowChar(' ', random(255), random(255), random(255), 0);
               delay(800);//直行箭头
 DispShowChar2('*',   255,255,0, 0);//数字1
 delay(3000);
 DispShowChar2('(',   255,255,0, 0);//数字2
 delay(3000);
 DispShowChar2(')',   255,255,0, 0);//数字3
 delay(3000);
 DispShowChar2('H',   255,255,0, 0);//数字4
 delay(3000);
 DispShowChar2('I',   255,255,0, 0);//数字5
 delay(3000);
 DispShowChar2('e',   255,255,0, 0);//对勾
 delay(3000);
 DispShowChar2('J',   0,0,255, 0);//八叉
 delay(3000);
 DispShowChar2('i',   0,0,255, 0);//笑脸
 delay(3000);
  DispShowChar2('a',   255,255,0, 0);//N
 delay(3000);
  DispShowChar2('b',   255,255,0, 0);//J
 delay(3000);
  DispShowChar2('c',   255,255,0, 0);//U
 delay(3000);
  /*if (Serial.available() > 0)
  {
    ...
    switch (c)
    {
      ...
      case 'G': 
        break;
      case 'H': DispShowChar2('(',   255,255,255, 0);//数字2
        break;
      case 'I': DispShowChar2(')',   255,255,255, 0);//数字3
        break;
      case 'J': DispShowChar2('e',   255,255,255, 0);//对勾
        break;
