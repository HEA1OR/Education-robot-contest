...
int lightNumber = 29;            // 灯珠数量
int leftStartLight = 0;          // 左侧灯珠的起始位置
int rightStartLight = 29;        // 右侧灯珠的起始位置
int leftEndLight = 14;           // 左侧灯珠的结束位置
int rightEndLight = 15;          // 右侧灯珠的结束位置
int leftMainLight = 0;           // 流水灯的主灯位置（左）
int rightMainLight = 29;         // 流水灯的主灯位置（右）
int sideBrightness = 100;        // 侧灯的最大亮度
int tailGroup[] = {14, 15};// 尾灯的灯珠位置
