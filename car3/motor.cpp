...
void motorInit() {
  ...
  //writeMicroseconds函数的取值是1000-2000,1495为静止,2000全速向前，1000全速向后
  motorL.writeMicroseconds(1495);
  motorR.writeMicroseconds(1495);
...
////////////////////////////////////////////////////////////////////
  ...
  motorL.writeMicroseconds(1495+left_speed);
  motorR.writeMicroseconds(1495-right_speed);
}
